--
-- Creating the table structure for table `nbc_category`
--

DROP TABLE IF EXISTS `nbc_category`;
CREATE TABLE IF NOT EXISTS `nbc_category` (
...
INSERT INTO `nbc_category` (`catID`, `catDesc`) VALUES
('PROG', 'Programming'),
('SYSD', 'Systems Design'),
...
--
-- Creating the table structure for table `nbc_books`
--

DROP TABLE IF EXISTS `nbc_books`;
CREATE TABLE IF NOT EXISTS `nbc_books` (
...
--
-- Insert data for table `nbc_books`
--

INSERT INTO `nbc_books` (`bookISBN`, `bookTitle`, `bookYear`, `pubID`, `catID`, `bookPrice`) VALUES
...
--
-- Creating the table structure for table `nbc_publisher`
--

DROP TABLE IF EXISTS `nbc_publisher`;
CREATE TABLE IF NOT EXISTS `nbc_publisher` (
...
--
-- Insert data for table `nbc_publisher`
--

INSERT INTO `nbc_publisher` (`pubID`, `pubName`, `location`) VALUES
...
--
-- Creating the table structure for table `te_users`
--

DROP TABLE IF EXISTS `nbc_users`;
...
--
-- Inserting data for table `nbc_users`
--

INSERT INTO `nbc_users` (`userID`, `firstname`, `surname`, `username`, `passwordHash`) VALUES
