--
-- Creating the table structure for table `nbc_special_offers`
--

DROP TABLE IF EXISTS `nbc_special_offers`;
CREATE TABLE IF NOT EXISTS `nbc_special_offers` (
...
--
-- Insert data for table `nbc_special_offers`
--

INSERT INTO `nbc_special_offers` (`bookISBN`, `bookTitle`, `bookYear`, `pubID`, `catID`, `bookPrice`) VALUES
...
('1954694274', 'XSL-FO', '2002', 'SAMS', 'PROG', 1000),
